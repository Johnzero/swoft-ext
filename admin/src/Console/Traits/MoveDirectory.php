...
trait MoveDirectory
{
    ...
    {
        $target = '@base/resource/views/swoft-admin';
        ...
        filesystem()->copyDirectory(__DIR__.'/../../../resource/views', alias($target));
    ...
    {
        $target = '@base/resource/languages';
        ...
        filesystem()->copyDirectory(__DIR__.'/../../../resource/lang', alias($target));
    ...
    {
        $target = '@base/public/assets/swoft-admin';
        ...
        filesystem()->copyDirectory(__DIR__.'/../../../resource/assets', alias($target));
